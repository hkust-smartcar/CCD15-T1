...
float ic_Kp = 8000;                   // Recommend 50
float ic_Kd = 15000;            	    // Recommend 45
...
//				last_speed_error = speed_error;
			    ...
			    if(ideal_speed != 0)
			    	anti_friction_angle = ideal_speed * 0.001;
...
//						power_l -= turn;
			...
			if((int32_t)(t-pt4) >= 1 && yo == 4){
				...
				printf("%f, %d, %d, %d\n", original_angle - raw_angle, count, border_l, border_r);
